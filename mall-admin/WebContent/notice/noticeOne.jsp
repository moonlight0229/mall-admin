...
<html>
	...
	<body>
		...
		<div class="container">
			<h1 class="display-4 mt-3 mb-3">공지사항 상세보기</h1>
			
			<div class="d-flex justify-content-end input-group mb-3">
				<a class="btn btn btn-primary mx-2" href="<%=request.getContextPath()%>/notice/updateNotice.jsp?noticeId=<%=notice.getNoticeId()%>">
					수정
				</a>
